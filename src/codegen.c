...
static int emit_rt_dynamic(FILE *out)
{
    ...
    if (!emit_str(out,
                ...
                "          break;\n"
                "        case I_TRAP_00: case I_TRAP_01: case I_TRAP_02: case I_TRAP_03: case I_TRAP_04: case I_TRAP_05:\n"
                "        case I_TRAP_06: case I_TRAP_07: case I_TRAP_08: case I_TRAP_09: case I_TRAP_10: case I_TRAP_11:\n"
                "        case I_TRAP_12: case I_TRAP_13:\n"
                "          fprintf(stderr, \"EXEC_ERROR: ERR_TRAP\\n\"); return 1;\n"
                "        case I_NOP: break;\n"
                "      }\n"
                "    }\n"
                "    if (do_tp)\n"
